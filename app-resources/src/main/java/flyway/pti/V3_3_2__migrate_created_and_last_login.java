...
public class V3_3_2__migrate_created_and_last_login extends BaseJavaMigration {
    ...
    public void migrate(Context context) throws Exception {
        ...
        users.forEach(user -> {
            ...
            try {
                ...
                String lastLogin = attributes.getString("lastLogin");
                attributes.remove("created");
                attributes.remove("lastLogin");
    ...
    public List<User> getUsers(Connection conn) throws Exception {
        ...
        final String sql = "SELECT id, user_name, attributes FROM oskari_users;";
...
//        final String sql = "UPDATE oskari_users_migration_test SET attributes = ?, created = ? , last_login = ? WHERE id = ?";
